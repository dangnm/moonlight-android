...
public class PreferenceConfiguration {
    ...
    private static final String ENABLE_BACK_MENU_PREF_STRING = "checkbox_back_menu";
    ...
    private static final boolean DEFAULT_ENABLE_BACK_MENU = false;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.enableBackMenu = prefs.getBoolean(ENABLE_BACK_MENU_PREF_STRING, DEFAULT_ENABLE_BACK_MENU);
